        ...
        (function() {
          ...
          function showContextMenu(params) {
            ...
            Object.assign(menu.style, {
              ...
              zIndex: '2147483647',
              minWidth: '220px',
              backgroundColor: isDark ? 'rgba(41, 42, 45, 0.95)' : 'rgba(255, 255, 255, 0.85)',
              backdropFilter: 'blur(40px)',
              webkitBackdropFilter: 'blur(40px)',
              borderRadius: '16px',
              padding: '6px',
              boxShadow: isDark ? '0 20px 50px rgba(0,0,0,0.4)' : '0 20px 40px rgba(0,0,0,0.15)',
              fontFamily: 'system-ui, -apple-system, BlinkMacSystemFont, "Inter", sans-serif',
              fontSize: '13px',
              fontWeight: '500',
              color: isDark ? '#f1f3f4' : '#1d1d1f',
