...
import {
  ...
  History, Settings, Star, HelpCircle, Plus as PlusIcon, Monitor, Puzzle, Sparkles
} from 'lucide-react';
    ...
    <div className="relative" ref={menuBtnRef}>
      <TooltipWrapper text="Customize and control Orbit">
        <button
          type="button"
          onClick={openMenu}
          className={`w-7 h-7 flex items-center justify-center rounded-full transition-all duration-200 cursor-pointer relative ${menuOpen
      ...
      <AnimatePresence>
        {menuOpen && (
          <>
            {/* Backdrop */}
            <div 
              className="fixed inset-0 z-[80000]" 
              style={{ zIndex: 80000 }} 
              onClick={closeMenu} 
            />
            ...
            <motion.div
              ...
              className="absolute right-0 z-[80001] mt-2 w-64 rounded-xl bg-white/95 dark:bg-[#28292d]/95 backdrop-blur-xl border border-black/8 dark:border-white/10 shadow-2xl overflow-hidden"
              style={{ top: '100%', zIndex: 80001 }}
            >
              {/* Zoom row */}
                ...
                <>
                  <div className="py-1.5">
                    {[
                      ...
                      { icon: Sparkles, label: 'Ask Orbit AI', shortcut: '⌘I', action: () => onOpenSidekick?.() },
