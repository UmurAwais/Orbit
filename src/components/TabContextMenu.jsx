...
const TabContextMenu = ({ menu, onClose }) => {
  ...
  return (
    <div
      ...
      className="w-64 bg-white/80 dark:bg-[#28282b]/95 border border-black/5 dark:border-white/10 rounded-xl shadow-[0_20px_40px_rgba(0,0,0,0.25)] p-1.5 backdrop-blur-2xl text-[13px] text-nexus-text flex flex-col font-medium"
    >
      <button 
